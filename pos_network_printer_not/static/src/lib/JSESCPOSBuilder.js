...
(function (Neodynamic) {
    ...
    (function (JSESCPOSBuilder) {
        ...
        JSESCPOSBuilder.XMLNode = XMLNode;
...
//                const xml = this.mustache.render(template, scope);
        ...
        JSESCPOSBuilder.TemplateParser = TemplateParser
        ...
        JSESCPOSBuilder.XMLParser = XMLParser;
        ...
        JSESCPOSBuilder.BufferBuilder = BufferBuilder;
