...
export declare class NodeFactory {
    static create(nodeType: String, node: any): AlignNode | BarcodeNode | BoldNode | BreakLineNode | DocumentNode | LineFeedNode | QRcodeNode | SmallNode | TextNode | TextLineNode | UnderlineNode | WhiteModeNode | PaperCutNode | ImageNode;
}
